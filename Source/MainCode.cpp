...
int main(int argc, char* argv[])
{
	...
	//Display settings for user in command prompt
	std::cout << "\n Movement Controls\n";
	std::cout << "ESC - Close application window\n";
	std::cout << "W - Zoom in / Move forward\n";
	std::cout << "S - Zoom out / Move backwards\n";
	std::cout << "A - Pan left / Move left\n";
	std::cout << "D - Pan right / Move right\n";
	std::cout << "Q - Pan up / Move upwards\n";
	std::cout << "E - Pan Down / Move downwards\n";
	std::cout << "O - front view (Ortho)\n";
	std::cout << "P - perspective view\n";
	std::cout << "Scroll forward - decrease camera move speed\n";
	std::cout << "Scroll backwards - increase camera move speed\n";
